...
|------|------|--------|------|------|------|--------|------|
| C01 | 8s | 4 | C01_first.png | C01_last.png | 医院病房 | 是 | 独立首帧 |
| C02 | 9s | 3 | C01_last.png | C02_last.png | 医院病房 | 是 | 沿用C01末帧 |
| C03 | 8s | 4 | C02_last.png | C03_last.png | 闪白转场 | - | 沿用C02末帧（强制共享帧） |
...
### C01 临终病房（8s，4分镜）| 首帧：C01_first.png | 末帧：C01_last.png
...
### C02 手机特写到眼泪（9s，3分镜）| 首帧：C01_last.png | 末帧：C02_last.png
...
### C03 闪白转场（8s，4分镜）| 首帧：C02_last.png | 末帧：C03_last.png
