...
from common import PROJECT_ROOT, create_client, default_output_path, generate_image_with_fallback, save_image_payload
...
def main() -> None:
    ...
    result = {
        ...
        "local_path": str(saved_path.relative_to(PROJECT_ROOT)),
    }
