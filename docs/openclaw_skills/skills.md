...
ClawHub is the public skills registry for OpenClaw. Browse at https://clawhub.com. Use it to discover, install, update, and back up skills.
...
If you want stock image generation/editing inside OpenClaw itself, use the core `image_generate` tool with `agents.defaults.imageGenerationModel` instead of a bundled skill. Skill examples here are for custom or third-party workflows.
...
See [Skills Config](./skills_config.md) for the full configuration schema.
